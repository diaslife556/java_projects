...
public class CM8 {
    public static void main(String[] args) {
        ...
        listaProjekt.add(new Projekt("Garaža", "Zagreb", 1000000.0, LocalDate.of(2026, 8, 21)));
        listaProjekt.add(new Projekt("Novotel", "Osijek",  2500000.0, LocalDate.of(2023, 6, 15)));
        listaProjekt.add(new Projekt("Voćarnica", "Županja",  50000.0,  LocalDate.of(2024, 7, 29)));
        ...
        listaRadnika.add(new Radnik("Marko", "Marković", 5.5, "Županja"));
        ...
        listaZadataka.add(new Zadatak("Postavljanje tapeta", 4, 2000.0, "Završen"));
        listaZadataka.add(new Zadatak( "Umrežavanje", 9, 3000.0, "NijePočeo"));
        ...
        listaProjekt.get(2).dodijeliZadatakProjektu(listaZadataka.get(1));
        ...
        for (ProjektniProces proces : listaProcesa) {
            ...
            if (ok) {
                ...
                System.out.println("Dokumentacija NIJE ispravna.");
            }
            proces.ispišiDatum();
        }
        ...
        while (odabir != 0) {
            ...
            switch(odabir) {
                case 1:
                    ...
                    String[] dozvole = dozvoleMerged.split(" ");
